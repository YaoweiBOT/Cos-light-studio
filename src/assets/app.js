import {defaults,clone,validateState,PRESETS,MODIFIERS,CAMERAS,LENSES,FLASHES,presetState,aimedLights} from './state.js';
...
const modifierOf=l=>l.type==='fresnel'?undefined:MODIFIERS.find(m=>l.modifier?m.id===l.modifier&&m.shape===l.shape&&m.width===l.width&&m.height===l.height:m.shape===l.shape&&m.width===l.width&&m.height===l.height);
