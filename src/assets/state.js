...
export const MODIFIERS=[
 {id:'disk60',label:'60 cm 圆形柔光箱',shape:'disk',width:.6,height:.6},
 {id:'disk120',label:'120 cm 圆形柔光箱',shape:'disk',width:1.2,height:1.2},
 {id:'strip',label:'30 × 120 cm 条形箱',shape:'rect',width:.3,height:1.2},
 {id:'rect',label:'60 × 90 cm 矩形箱',shape:'rect',width:.6,height:.9},
...
export const PRESETS=[
 ...
 {id:'split',name:'侧光',tag:'04 / 明暗分界',desc:'灯放在侧面，微调脸朝向。观察鼻梁遮挡、脸颊高光与暗侧的反射补光。',light:{azimuth:-90,heightY:1.72,distance:1.25,width:.35,height:.35}},
 ...
 {id:'cosplay',name:'冷暖三灯',tag:'07 / 分离人物',desc:'中性主光、冷色轮廓、暖色高位光。先逐盏单独观察，再合起来；避免依靠整体提亮掩盖溢光。',light:{width:1.2,height:1.2,power:0,azimuth:-40,heightY:2.1},rim:{enabled:true,kelvin:9500,tint:10,power:-1},top:{enabled:true,kelvin:3200,power:-2,azimuth:150,distance:.7}},
 {id:'clamshell',name:'高位光 + 反光板',tag:'08 / 真实反射',desc:'正面高位主光，白色板置于下方。将反光板改成黑板，比较下颌与暗部的变化。',light:{azimuth:0,heightY:2.2,distance:1.05,width:.9,height:.9},board:'below'},
 {id:'fresnel',name:'菲涅尔 · 聚光 / 泛光',tag:'10 / 控制光束',desc:'固定灯位和功率，调整 15° → 60° 光束。看覆盖范围与中心亮度，再改变出光口直径观察阴影；光束边缘与鼻影柔度分别控制。',light:{type:'fresnel',beam:35,edge:.45,aperture:.12,power:-2,azimuth:-35,heightY:2.1}},
 {id:'white',name:'双板白棚',tag:'11 / 暗部反弹',desc:'左右两块白板和浅色墙地面共同反射。将一侧换成黑板，比较暗侧与下颌；环境光仍为零。',light:{width:1.2,height:1.2,azimuth:-35,heightY:2.1},white:true},
 {id:'hard',name:'硬光练习',tag:'09 / 看清边缘',desc:'10 cm 小发光面。把尺寸慢慢增大，注意阴影边缘和高光面积；总光通量保持不变。',light:{width:.1,height:.1,azimuth:-45,distance:1.4,heightY:2.05}}
];
