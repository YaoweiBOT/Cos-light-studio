...
`;var zf=`
	${Wi}
	${Vi}
`;function Dr(i,e,t=0){if(i.isInterleavedBufferAttribute){let r=i.itemSize;for(let s=0,n=i.count;s<n;s++){let o=s+t;e.setX(o,i.getX(s)),r>=2&&e.setY(o,i.getY(s)),r>=3&&e.setZ(o,i.getZ(s)),r>=4&&e.setW(o,i.getW(s))}}else{let r=e.array,s=r.constructor,n=r.BYTES_PER_ELEMENT*i.itemSize*t;new s(r.buffer,n,i.array.length).set(i.array)}}function je(i,e=null){let t=i.array.constructor,r=i.normalized,s=i.itemSize,n=e===null?i.count:e;return new O(new t(s*n),s,r)}function ze(i,e){if(!i&&!e)return!0;if(!!i!=!!e)return!1;let t=i.count===e.count,r=i.normalized===e.normalized,s=i.array.constructor===e.array.constructor,n=i.itemSize===e.itemSize;return!(!t||!r||!s||!n)}function Ga(i){let e=i[0].index!==null,t=new Set(Object.keys(i[0].attributes));if(!i[0].getAttribute("position"))throw new Error("StaticGeometryGenerator: position attribute is required.");for(let r=0;r<i.length;++r){let s=i[r],n=0;if(e!==(s.index!==null))throw new Error("StaticGeometryGenerator: All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.");for(let o in s.attributes){if(!t.has(o))throw new Error('StaticGeometryGenerator: All geometries must have compatible attributes; make sure "'+o+'" attribute exists among all geometries, or in none of them.');n++}if(n!==t.size)throw new Error("StaticGeometryGenerator: All geometries must have the same number of attributes.")}}function Wa(i){let e=0;for(let t=0,r=i.length;t<r;t++)e+=i[t].getIndex().count;return e}function Va(i){let e=0;for(let t=0,r=i.length;t<r;t++)e+=i[t].getAttribute("position").count;return e}function qa(i,e,t){i.index&&i.index.count!==e&&i.setIndex(null);let r=i.attributes;for(let s in r)r[s].count!==t&&i.deleteAttribute(s)}function Vo(i,e={},t=new se){let{useGroups:r=!1,forceUpdate:s=!1,skipAssigningAttributes:n=[],overwriteIndex:o=!0}=e;Ga(i);let a=i[0].index!==null,l=a?Wa(i):-1,h=Va(i);if(qa(t,l,h),r){let u=0;for(let c=0,m=i.length;c<m;c++){let g=i[c],b;a?b=g.getIndex().count:b=g.getAttribute("position").count,t.addGroup(u,b,c),u+=b}}if(a){let u=!1;if(t.index||(t.setIndex(new O(new Uint32Array(l),1,!1)),u=!0),u||o){let c=0,m=0,g=t.getIndex();for(let b=0,d=i.length;b<d;b++){let v=i[b],p=v.getIndex();if(!(!s&&!u&&n[b]))for(let y=0;y<p.count;++y)g.setX(c+y,p.getX(y)+m);c+=p.count,m+=v.getAttribute("position").count}}}let f=Object.keys(i[0].attributes);for(let u=0,c=f.length;u<c;u++){let m=!1,g=f[u];if(!t.getAttribute(g)){let v=i[0].getAttribute(g);t.setAttribute(g,je(v,h)),m=!0}let b=0,d=t.getAttribute(g);for(let v=0,p=i.length;v<p;v++){let x=i[v],y=!s&&!m&&n[v],T=x.getAttribute(g);if(!y)if(g==="color"&&d.itemSize!==T.itemSize)for(let S=b,w=T.count;S<w;S++)T.setXYZW(S,d.getX(S),d.getY(S),d.getZ(S),1);else Dr(T,d,b);b+=T.count}}}function qo(i,e,t){let r=i.index,n=i.attributes.position.count,o=r?r.count:n,a=i.groups;a.length===0&&(a=[{count:o,start:0,materialIndex:0}]);let l=i.getAttribute("materialIndex");if(!l||l.count!==n){let f;t.length<=255?f=new Uint8Array(n):f=new Uint16Array(n),l=new O(f,1,!1),i.deleteAttribute("materialIndex"),i.setAttribute("materialIndex",l)}let h=l.array;for(let f=0;f<a.length;f++){let u=a[f],c=u.start,m=u.count,g=Math.min(m,o-c),b=Array.isArray(e)?e[u.materialIndex]:e,d=t.indexOf(b);for(let v=0;v<g;v++){let p=c+v;r&&(p=r.getX(p)),h[p]=d}}}function Yo(i,e){if(!i.index){let t=i.attributes.position.count,r=new Array(t);for(let s=0;s<t;s++)r[s]=s;i.setIndex(r)}if(!i.attributes.normal&&e&&e.includes("normal")&&i.computeVertexNormals(),!i.attributes.uv&&e&&e.includes("uv")){let t=i.attributes.position.count;i.setAttribute("uv",new O(new Float32Array(t*2),2,!1))}if(!i.attributes.uv2&&e&&e.includes("uv2")){let t=i.attributes.position.count;i.setAttribute("uv2",new O(new Float32Array(t*2),2,!1))}if(!i.attributes.tangent&&e&&e.includes("tangent"))if(i.attributes.uv&&i.attributes.normal)i.computeTangents();else{let t=i.attributes.position.count;i.setAttribute("tangent",new O(new Float32Array(t*4),4,!1))}if(!i.attributes.color&&e&&e.includes("color")){let t=i.attributes.position.count,r=new Float32Array(t*4);r.fill(1),i.setAttribute("color",new O(r,4))}}function yt(i){let e=0;if(i.byteLength!==0){let t=new Uint8Array(i);for(let r=0;r<i.byteLength;r++){let s=t[r];e=(e<<5)-e+s,e|=0}}return e}function $o(i){let e=i.uuid,t=Object.values(i.attributes);i.index&&(t.push(i.index),e+=`index|${i.index.version}`);let r=Object.keys(t).sort();for(let s of r){let n=t[s];e+=`${s}_${n.version}|`}return e}function jo(i){let e=i.skeleton;return e?(e.boneTexture||e.computeBoneTexture(),`${yt(e.boneTexture.image.data.buffer)}_${e.boneTexture.uuid}`):null}var Fr=class{constructor(e=null){this.matrixWorld=new U,this.geometryHash=null,this.skeletonHash=null,this.primitiveCount=-1,e!==null&&this.updateFrom(e)}updateFrom(e){let t=e.geometry,r=(t.index?t.index.count:t.attributes.position.count)/3;this.matrixWorld.copy(e.matrixWorld),this.geometryHash=$o(t),this.primitiveCount=r,this.skeletonHash=jo(e)}didChange(e){let t=e.geometry,r=(t.index?t.index.count:t.attributes.position.count)/3;return!(this.matrixWorld.equals(e.matrixWorld)&&this.geometryHash===$o(t)&&this.skeletonHash===jo(e)&&this.primitiveCount===r)}};var Xe=new M,Qe=new M,Ke=new M,Xo=new Me,Cr=new M,qi=new M,Qo=new Me,Ko=new Me,Br=new U,Zo=new U;function Jo(i,e,t){let r=i.skeleton,s=i.geometry,n=r.bones,o=r.boneInverses;Qo.fromBufferAttribute(s.attributes.skinIndex,e),Ko.fromBufferAttribute(s.attributes.skinWeight,e),Br.elements.fill(0);for(let a=0;a<4;a++){let l=Ko.getComponent(a);if(l!==0){let h=Qo.getComponent(a);Zo.multiplyMatrices(n[h].matrixWorld,o[h]),Ya(Br,Zo,l)}}return Br.multiply(i.bindMatrix).premultiply(i.bindMatrixInverse),t.transformDirection(Br),t}function Yi(i,e,t,r,s){Cr.set(0,0,0);for(let n=0,o=i.length;n<o;n++){let a=e[n],l=i[n];a!==0&&(qi.fromBufferAttribute(l,r),t?Cr.addScaledVector(qi,a):Cr.addScaledVector(qi.sub(s),a))}s.add(Cr)}function Ya(i,e,t){let r=i.elements,s=e.elements;for(let n=0,o=s.length;n<o;n++)r[n]+=s[n]*t}function $a(i){let{index:e,attributes:t}=i;if(e)for(let r=0,s=e.count;r<s;r+=3){let n=e.getX(r),o=e.getX(r+2);e.setX(r,o),e.setX(r+2,n)}else for(let r in t){let s=t[r],n=s.itemSize;for(let o=0,a=s.count;o<a;o+=3)for(let l=0;l<n;l++){let h=s.getComponent(o,l),f=s.getComponent(o+2,l);s.setComponent(o,l,f),s.setComponent(o+2,l,h)}}return i}function en(i,e={},t=new se){e={applyWorldTransforms:!0,attributes:[],...e};let r=i.geometry,s=e.applyWorldTransforms,n=e.attributes.includes("normal"),o=e.attributes.includes("tangent"),a=r.attributes,l=t.attributes;for(let p in t.attributes)(!e.attributes.includes(p)||!(p in r.attributes))&&t.deleteAttribute(p);!t.index&&r.index&&(t.index=r.index.clone()),l.position||t.setAttribute("position",je(a.position)),n&&!l.normal&&a.normal&&t.setAttribute("normal",je(a.normal)),o&&!l.tangent&&a.tangent&&t.setAttribute("tangent",je(a.tangent)),ze(r.index,t.index),ze(a.position,l.position),n&&ze(a.normal,l.normal),o&&ze(a.tangent,l.tangent);let h=a.position,f=n?a.normal:null,u=o?a.tangent:null,c=r.morphAttributes.position,m=r.morphAttributes.normal,g=r.morphAttributes.tangent,b=r.morphTargetsRelative,d=i.morphTargetInfluences,v=new As;v.getNormalMatrix(i.matrixWorld),r.index&&t.index.array.set(r.index.array);for(let p=0,x=a.position.count;p<x;p++)Xe.fromBufferAttribute(h,p),f&&Qe.fromBufferAttribute(f,p),u&&(Xo.fromBufferAttribute(u,p),Ke.fromBufferAttribute(u,p)),d&&(c&&Yi(c,d,b,p,Xe),m&&Yi(m,d,b,p,Qe),g&&Yi(g,d,b,p,Ke)),i.isSkinnedMesh&&(i.applyBoneTransform(p,Xe),f&&Jo(i,p,Qe),u&&Jo(i,p,Ke)),s&&Xe.applyMatrix4(i.matrixWorld),l.position.setXYZ(p,Xe.x,Xe.y,Xe.z),f&&(s&&Qe.applyNormalMatrix(v),l.normal.setXYZ(p,Qe.x,Qe.y,Qe.z)),u&&(s&&Ke.transformDirection(i.matrixWorld),l.tangent.setXYZW(p,Ke.x,Ke.y,Ke.z,Xo.w));for(let p in e.attributes){let x=e.attributes[p];x==="position"||x==="tangent"||x==="normal"||!(x in a)||(l[x]||t.setAttribute(x,je(a[x])),ze(a[x],l[x]),Dr(a[x],l[x]))}return i.matrixWorld.determinant()<0&&$a(t),t}var Lr=class extends se{constructor(){super(),this.version=0,this.hash=null,this._diff=new Fr}isCompatible(e,t){let r=e.geometry;for(let s=0;s<t.length;s++){let n=t[s],o=r.attributes[n],a=this.attributes[n];if(o&&!ze(o,a))return!1}return!0}updateFrom(e,t){let r=this._diff;return r.didChange(e)?(en(e,t,this),r.updateFrom(e),this.version++,this.hash=`${this.uuid}_${this.version}`,!0):!1}};var zr=0,$i=1,ji=2;function ja(i,e){for(let t=0,r=i.length;t<r;t++)i[t].traverseVisible(n=>{n.isMesh&&e(n)})}function Xa(i){let e=[];for(let t=0,r=i.length;t<r;t++){let s=i[t];Array.isArray(s.material)?e.push(...s.material):e.push(s.material)}return e}function Qa(i,e,t){if(i.length===0){e.setIndex(null);let r=e.attributes;for(let s in r)e.deleteAttribute(s);for(let s in t.attributes)e.setAttribute(t.attributes[s],new O(new Float32Array(0),4,!1))}else Vo(i,t,e);for(let r in e.attributes)e.attributes[r].needsUpdate=!0}var Nr=class{constructor(e){this.objects=null,this.useGroups=!0,this.applyWorldTransforms=!0,this.generateMissingAttributes=!0,this.overwriteIndex=!0,this.attributes=["position","normal","color","tangent","uv","uv2"],this._intermediateGeometry=new Map,this._geometryMergeSets=new WeakMap,this._mergeOrder=[],this._dummyMesh=null,this.setObjects(e||[])}_getDummyMesh(){if(!this._dummyMesh){let e=new Jt,t=new se;t.setAttribute("position",new O(new Float32Array(9),3)),this._dummyMesh=new Q(t,e)}return this._dummyMesh}_getMeshes(){let e=[];return ja(this.objects,t=>{e.push(t)}),e.sort((t,r)=>t.uuid>r.uuid?1:t.uuid<r.uuid?-1:0),e.length===0&&e.push(this._getDummyMesh()),e}_updateIntermediateGeometries(){let{_intermediateGeometry:e}=this,t=this._getMeshes(),r=new Set(e.keys()),s={attributes:this.attributes,applyWorldTransforms:this.applyWorldTransforms};for(let n=0,o=t.length;n<o;n++){let a=t[n],l=a.uuid;r.delete(l);let h=e.get(l);(!h||!h.isCompatible(a,this.attributes))&&(h&&h.dispose(),h=new Lr,e.set(l,h)),h.updateFrom(a,s)&&this.generateMissingAttributes&&Yo(h,this.attributes)}r.forEach(n=>{e.delete(n)})}setObjects(e){Array.isArray(e)?this.objects=[...e]:this.objects=[e]}generate(e=new se){let{useGroups:t,overwriteIndex:r,_intermediateGeometry:s,_geometryMergeSets:n}=this,o=this._getMeshes(),a=[],l=[],h=n.get(e)||[];this._updateIntermediateGeometries();let f=!1;o.length!==h.length&&(f=!0);for(let c=0,m=o.length;c<m;c++){let g=o[c],b=s.get(g.uuid);l.push(b);let d=h[c];!d||d.uuid!==b.uuid?(a.push(!1),f=!0):d.version!==b.version?a.push(!1):a.push(!0)}Qa(l,e,{useGroups:t,forceUpdate:f,skipAssigningAttributes:a,overwriteIndex:r}),f&&e.dispose(),n.set(e,l.map(c=>({version:c.version,uuid:c.uuid})));let u=zr;return f?u=ji:a.includes(!1)&&(u=$i),{changeType:u,materials:Xa(o),geometry:e}}};function Ka(i){let e=new Set;for(let t=0,r=i.length;t<r;t++){let s=i[t];for(let n in s){let o=s[n];o&&o.isTexture&&e.add(o)}}return Array.from(e)}function Za(i){let e=[],t=new Set;for(let s=0,n=i.length;s<n;s++)i[s].traverse(o=>{o.visible&&(o.isRectAreaLight||o.isSpotLight||o.isPointLight||o.isDirectionalLight)&&(e.push(o),o.iesMap&&t.add(o.iesMap))});let r=Array.from(t).sort((s,n)=>s.uuid<n.uuid?1:s.uuid>n.uuid?-1:0);return{lights:e,iesTextures:r}}var Or=class{get initialized(){return!!this.bvh}constructor(e){this.bvhOptions={},this.attributes=["position","normal","tangent","color","uv","uv2"],this.generateBVH=!0,this.bvh=null,this.geometry=new se,this.staticGeometryGenerator=new Nr(e),this._bvhWorker=null,this._pendingGenerate=null,this._buildAsync=!1,this._materialUuids=null}setObjects(e){this.staticGeometryGenerator.setObjects(e)}setBVHWorker(e){this._bvhWorker=e}async generateAsync(e=null){if(!this._bvhWorker)throw new Error('PathTracingSceneGenerator: "setBVHWorker" must be called before "generateAsync" can be called.');if(this.bvh instanceof Promise)return this._pendingGenerate||(this._pendingGenerate=new Promise(async()=>(await this.bvh,this._pendingGenerate=null,this.generateAsync(e)))),this._pendingGenerate;{this._buildAsync=!0;let t=this.generate(e);return this._buildAsync=!1,t.bvh=this.bvh=await t.bvh,t}}generate(e=null){let{staticGeometryGenerator:t,geometry:r,attributes:s}=this,n=t.objects;t.attributes=s,n.forEach(c=>{c.traverse(m=>{m.isSkinnedMesh&&m.skeleton&&m.skeleton.update()})});let o=t.generate(r),a=o.materials,l=o.changeType!==zr||this._materialUuids===null||this._materialUuids.length!==length;if(!l){for(let c=0,m=a.length;c<m;c++)if(a[c].uuid!==this._materialUuids[c]){l=!0;break}}let h=Ka(a),{lights:f,iesTextures:u}=Za(n);if(l&&(qo(r,a,a),this._materialUuids=a.map(c=>c.uuid)),this.generateBVH){if(this.bvh instanceof Promise)throw new Error("PathTracingSceneGenerator: BVH is already building asynchronously.");if(o.changeType===ji){let c={strategy:2,maxLeafTris:1,indirect:!0,onProgress:e,...this.bvhOptions};this._buildAsync?this.bvh=this._bvhWorker.generate(r,c):this.bvh=new Er(r,c)}else o.changeType===$i&&this.bvh.refit()}return{bvhChanged:o.changeType!==zr,bvh:this.bvh,needsMaterialIndexUpdate:l,lights:f,iesTextures:u,geometry:r,materials:a,textures:h,objects:n}}};var Ja=new Os(-1,1,1,-1,0,1),Xi=class extends se{constructor(){super(),this.setAttribute("position",new yi([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new yi([0,2,0,0,2,0],2))}},ec=new Xi,fe=class{constructor(e){this._mesh=new Q(ec,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Ja)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}};var Oe=class extends be{set needsUpdate(e){super.needsUpdate=!0,this.dispatchEvent({type:"recompilation"})}constructor(e){super(e);for(let t in this.uniforms)Object.defineProperty(this,t,{get(){return this.uniforms[t].value},set(r){this.uniforms[t].value=r}})}setDefine(e,t=void 0){if(t==null){if(e in this.defines)return delete this.defines[e],this.needsUpdate=!0,!0}else if(this.defines[e]!==t)return this.defines[e]=t,this.needsUpdate=!0,!0;return!1}};var kr=class extends Oe{constructor(e){super({blending:Te,uniforms:{target1:{value:null},target2:{value:null},opacity:{value:1}},vertexShader:`
